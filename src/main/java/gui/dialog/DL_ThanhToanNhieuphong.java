...
public class DL_ThanhToanNhieuphong extends javax.swing.JDialog {
    ...
    private void btnThanhToanNhieuActionPerformed(java.awt.event.ActionEvent evt) {
            ...
            SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
                ...
                protected Void doInBackground() throws Exception {
                    ...
                    int yesNo = JOptionPane.showConfirmDialog(
                            null, "Bạn có chắc muốn thanh toán không?", "Thông báo", JOptionPane.YES_NO_OPTION);
        ...
        if (validDateSDT()) {
            SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
                        ...
                        if (hd.size() > 0) {
                            for (HoaDon hoaDon : hd) {
                                if (hoaDon.getTongTien() == 0) {
                                    ...
                                    System.out.println(dsCTHDP.size());
                ...
                protected void done() {
                    if (khachHang == null) {
                        Notification noti = new Notification(
                                (java.awt.Frame) SwingUtilities.getWindowAncestor(DL_ThanhToanNhieuphong.this),
                                Notification.Type.WARNING,
                                Notification.Location.TOP_RIGHT,
