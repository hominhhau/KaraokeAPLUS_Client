...
import interfaceClient.impl.DonDatPhongClient;
...
public class DL_ChonNhieuPhong extends javax.swing.JDialog {
	...
	private DonDatPhongInter ddp_dao;
	...
	public void loadData() {
		...
		for (PhongHat ph : phongTrongList) {
			setLoaiPhong(ph);
			dtm.addRow(new Object[] { ph.getMaPhong(), ph.getTenPhong(), loaiPhong, gia });
		}
	...
	private void initComponents() {
		...
		}, new String[] { "Mã Phòng", "Tên Phòng", "Loại Phòng", "Giá Phòng" }) {
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				...
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
						jPanel1Layout.createSequentialGroup().addGap(0, 0, Short.MAX_VALUE)
								...
								.addGap(139, 139, 139).addComponent(btnExit, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
						jPanel1Layout.createSequentialGroup()
								.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(btnDatNhieuPhong, javax.swing.GroupLayout.PREFERRED_SIZE, 90,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addContainerGap()));
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup()
						...
						.addComponent(btnDatNhieuPhong, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addContainerGap()));
	...
	private boolean daDatPhong = false;

	private void btnDatNhieuPhongActionPerformed(java.awt.event.ActionEvent evt) {
		...
		Thread workerThread = new Thread(new Runnable() {
			...
			public void run() {
				...
				String maNV = (nhanVienDangNhap != null) ? nhanVienDangNhap.getMaNV() : "NV001";
				double tongTien = 0;
				LocalDate ngayLapHD = LocalDate.now();
				String maKM = null;

				HoaDonClient hd_dao = new HoaDonClient(); // Tạo đối tượng HoaDonClient

				// Tạo hóa đơn duy nhất
				HoaDon hd = new HoaDon(maHD, ngayLapHD, new KhachHang(maKH), new NhanVien(maNV), tongTien);
				hd_dao.createHoaDon(hd);

				String maHDforN = hd.getMaHD();

				// Lấy chỉ mục hàng đã chọn trong jTable1
				...
				if (selectedRows.length == 0) {
					...
					ChiTietHoaDonPhongClient cthdp_dao = new ChiTietHoaDonPhongClient();
					List<String> selectedPhongList = new ArrayList<>(); // Danh sách các phòng được chọn

					for (int selectedRow : selectedRows) {
						selectionModel.removeSelectionInterval(selectedRow, selectedRow); // Bỏ chọn hàng đã xử lý
						String maPhong = (String) jTable1.getValueAt(selectedRow, 0);
						double gia = 0;
						LocalDateTime gioVao = LocalDateTime.now();
						LocalDateTime gioRa = gioVao;
						String maGiamGia = null;

						// Gán hóa đơn cho mỗi chi tiết hóa đơn phòng
						ChiTietHoaDonPhong cthdp = new ChiTietHoaDonPhong(hd, new PhongHat(maPhong), gia, gioVao, gioRa, maGiamGia);
						cthdp_dao.createChiTietHoaDonPhong(cthdp);
						PhongHatClient ph_dao = new PhongHatClient(); // Tạo đối tượng PhongHatClient
						ph_dao.updateTinhTrangPhong(maPhong, "Dang su dung");

						selectedPhongList.add(maPhong); // Thêm phòng vào danh sách
					}

					// Cập nhật giao diện trong Event Dispatch Thread (EDT)
					...
					// Xử lý danh sách các phòng đã chọn
					// TODO: Thực hiện các công việc cần thiết với danh sách các phòng đã chọn
					// Ví dụ: In danh sách các phòng đã chọn
					for (String maPhong : selectedPhongList) {
						System.out.println("Phòng đã chọn: " + maPhong);
					}
				}
			}
		});
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(DL_ChonNhieuPhong.class.getName()).log(java.util.logging.Level.SEVERE,
					null, ex);
