...
public void setLblChiTietPhongDSD() {
    ...
    if (result != null) {
        ...
        // Xử lý khi không tìm thấy chi tiết hóa đơn phòng
        // Ví dụ: Hiển thị thông báo lỗi, gán giá trị mặc định, v.v.
        System.out.println("Không tìm thấy chi tiết hóa đơn phòng");
    }
}
