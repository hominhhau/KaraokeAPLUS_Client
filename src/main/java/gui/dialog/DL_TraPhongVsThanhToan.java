...
public class DL_TraPhongVsThanhToan extends javax.swing.JDialog {
    ...
    private LocalDateTime gioSD;
    private static String maHDDSD;
    private Double tongTien;
    private KhuyenMaiInter km_dao;
    ...
    public String getMaPhongDSD() {
        Form_QuanLyDatPhong frmPH = new Form_QuanLyDatPhong();
        String maPhongDSD = frmPH.getRoomSelected();
        System.out.println("MaPhongDSD:" + maPhongDSD);
        return maPhongDSD;
    }

    public void setGia(String maPhongDSD) {
        PhongHat ph = ph_dao.getPhongHatByMaPhong(maPhongDSD);
    ...
    public void calculateThanhTien(String maHD, String maPhongDSD) {
        ChiTietHoaDonPhong ct = cthdp_dao.getChiTietHoaDonPhongTheoMaHD(maHD, maPhongDSD);
        gioVao = ct.getGioVao();
    ...
    public void updateGioRaVsGia(String maHD, String maPhongDSD) {
//        cthdp_dao = new ChiTietHoaDonPhongClient();
        cthdp_dao.updateGioRaVsGia(maHD, LocalDateTime.now(), thanhTien, maPhongDSD);
    }

    public void tinhTien() {
        String maHD = getMaHD();
        setMaHDDSD(maHD);
        String maPhongDSD = getMaPhongDSD();
        setGia(maPhongDSD);
        calculateThanhTien(maHD, maPhongDSD);
        updateGioRaVsGia(maHD, maPhongDSD);
    }
...
//    }
    public HoaDon getHD() {
        System.out.println("check mahddsd" + maHDDSD);
        return hd_dao.getHoaDonTheoMaHD(maHDDSD);
    }
    ...
    public void loadCustomerDetails() {
        ...
        System.out.println("hóa đơn :" + hd.getKhachHang().getMaKH());
...
//        int phutRa = ct.getGioRa().getMinute();
        // gán giờ ra bằng giờ hiện tại
        gioRa = LocalDateTime.now().getHour();
        phutRa = LocalDateTime.now().getMinute();
...
//            if (cthdp.getHoaDon().getMaHD().equals(maHDDSD) && cthdp.getPhongHat().getMaPhong().equals(frmPHforctp.getRoomSelected())) {
        ChiTietHoaDonPhong cthdp = cthdp_dao.getChiTietHoaDonPhongTheoMaHD(maHDDSD, frmPHforctp.getRoomSelected());
        System.out.println(cthdp.getGioVao());
        System.out.println(cthdp.getGioRa());
        System.out.println(cthdp.getGia());
        ...
        model.addRow(new Object[]{
                i++, cthdp.getPhongHat().getMaPhong(), displayTime,  thanhTien
        });
//            }
//        }
    ...
    private void btnThanhToanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThanhToanActionPerformed
        ...
        executor.submit(() -> {
            ...
            if (hd.getTongTien() == 0) {
                hd_dao.updateTongTien(maHDDSD, tongTienThanhToan, maKM);
            }
//            else {
