...
import interfaceClient.impl.LoaiNVClient;
...
public class Form_QuanLyNhanVien extends javax.swing.JPanel {
    ...
    private NhanVienInter nv_dao;
    private DefaultTableModel dtmNhanVien;
    private LoaiNVInter loainv_dao = new LoaiNVClient();

    public Form_QuanLyNhanVien() throws IOException {
        initComponents();
        TableActionEvent_NhanVien event = new TableActionEvent_NhanVien() {
            @Override
            public void Sua(int row) {
                nv_dao = new NhanVienClient();
     ...
     * @return
     */
    private void loadLoaiNhanVien() throws IOException {
        LoaiNVInter loainv_dao = new LoaiNVClient();
