...
public class Form_ThongKeMatHang extends javax.swing.JPanel {
    ...
    private ChiTietHoaDonDVInter ctdv_dao;
    ...
    public Form_ThongKeMatHang() {
        ...
        ctdv_dao = new ChiTietHoaDonDVClient();
    ...
    private void initComponents() {
        ...
        cmbTKChiTiet
                .setModel(new javax.swing.DefaultComboBoxModel<>(new String[]{"0", "2022", "2023", "2024", "2025", "2026"}));
            ...
            protected Void doInBackground() throws Exception {
                ...
                SwingUtilities.invokeLater(() -> {
                    ...
                    if (tongTienDV != 0) {
                        ...
                        txtTienDV.setText("0.0");
                    }
//                    double tongTienDV = ctdv_dao.getTongTienNam(nam);
//                    if (tongTienDV != 0) {
//                        txtTienDV.setText(String.valueOf(tongTienDV));
//                    } else {
//                        txtTienDV.setText("0.0");
//                    }
                ...
                SwingUtilities.invokeLater(() -> {
                    double tongTienMH = 0.0;
                    int index = 1;
                    for (String[] arr : dsMHNam) {
                        String maDV = arr[0];
                        String tenDV = arr[1];
                        int soLuong = Integer.parseInt(arr[2]);
...
//                    Double tongTienMH = mh_dao.getTongTienNam(nam);
//                    if (tongTienMH != null) {
//                        txtTong.setText(String.valueOf(tongTienMH));
//                    } else {
...
//                double tongALLTien = ctdv_dao.getTongTienNgayDV(date);
//                if (tongALLTien != 0) {
//                    SwingUtilities.invokeLater(() -> {
...
//            double tongALLTien = ctdv_dao.getTongTienThangTop(thang, nam);
//            if (tongALLTien != 0) {
//                txtTienDV.setText(String.valueOf(tongALLTien));
//            } else {
//                txtTienDV.setText("0.0");
...
//            double tongTienMH = mh_dao.getTongTienThang(thang, nam);
//            if (tongTienMH != 0) {
//                txtTong.setText(String.valueOf(tongTienMH));
//            } else {
//                txtTong.setText("0.0");
